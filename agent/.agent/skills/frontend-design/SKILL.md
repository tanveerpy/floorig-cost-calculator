...
|--------|---------|-------|
| `scripts/ux_audit.py` | UX Psychology & Accessibility Audit | `python .agent/skills/frontend-design/scripts/ux_audit.py .` |
| `scripts/accessibility_checker.py` | Accessibility Check | `python .agent/skills/frontend-design/scripts/accessibility_checker.py .` |
