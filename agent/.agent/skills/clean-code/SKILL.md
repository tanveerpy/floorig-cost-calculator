...
| **adsense-specialist** | AdSense Audit | `python .agent/skills/adsense-optimization/scripts/adsense_checker.py .` |
| **eeat-specialist** | E-E-A-T Audit | `python .agent/skills/eeat-optimization/scripts/eeat_checker.py .` |
...
| **devops-engineer** | Security Scan | `python .agent/skills/vulnerability-scanner/scripts/security_scan.py .` |
